...
public class Database {
    ...
    public static int hsIsRWorded(String column) throws SQLException {
        PreparedStatement ps2 = postgresConnection.prepareStatement("SELECT nextval(?)");
        ps2.setString(1, column.concat("_seq"));
    ...
    public static void initDB() throws SQLException {
        ...
        postgresConnection = DriverManager.getConnection(url, user, pass);
